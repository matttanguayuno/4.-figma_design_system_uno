...
public sealed partial class PageAccordionControl : UserControl
{
    public static readonly DependencyProperty IsMobileProperty = DependencyProperty.Register(
        nameof(IsMobile), typeof(bool), typeof(PageAccordionControl), new PropertyMetadata(false));
